    ...
    >
      <div className="flex items-center gap-5 justify-between">
        ...
        <div
          ...
          style={{ transform: `scale(${logoScale})`, transformOrigin: " center" , paddingTop: showTop ? '20px' : '0px'}}
        >
        ...
        <div className="w-full">
          ...
          >
            ...
            <a
              ...
              className="text-[#CA1F34] text-center font-bold max-md:text-xs text-sm flex items-center gap-1 pr-2.5 lg:pr-10"
            >
